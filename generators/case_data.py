"""Single source of truth for the four Life Science Hub / Specialty Drug PA cases.

Everything in here is synthetic. Patients, prescribers, payers, plan policies,
drug brand names and J-codes are invented for demonstration purposes.
"""
...
CASES = [
    # ------------------------------------------------------------------ CASE 1
    {
        ...
        "flags": 0,
        "patient": {
            "name": "Marcus Ellison", "first": "Marcus", "age": "54M",
            "dob": "1971-06-18", "sex": "Male", "pid": "PT-4471002",
            "phone": "(312) 555-0148",
            "address": "1184 Ashgrove Lane, Evanston, IL 60201",
        },
        "payer": {
            "name": "Anvara Health Plan", "short": "Anvara",
            "plan": "Anvara Health Plan \u00b7 Anvara Choice PPO",
            "memberId": "AVH884210277", "group": "GRP-77120",
            "effective": "2026-01-01", "benefit": "Pharmacy \u00b7 Specialty tier 4",
        },
        "therapy": {
            "brand": "Velunexa", "generic": "velunekimab",
            "label": "Velunexa (velunekimab) 150 mg/mL",
            "cls": "Interleukin-23p19 inhibitor",
            "strength": "150 mg/mL single-dose prefilled syringe",
            "jcode": "J3592", "ndc": "58291-0150-01",
            "dose": "150 mg", "route": "Subcutaneous",
            "frequency": "Weeks 0 and 4, then every 12 weeks",
            "quantity": "1 syringe per fill", "daysSupply": "84",
            "siteOfCare": "Self-administered \u00b7 specialty pharmacy",
            "duration": "12 months", "requestType": "Initial \u00b7 Standard",
            "startDate": "2026-09-08",
        },
        "dx": {"code": "L40.0", "text": "Psoriasis vulgaris",
               "full": "L40.0 \u00b7 Psoriasis vulgaris (moderate-to-severe plaque)",
               "severity": "BSA 18% \u00b7 PASI 16.4"},
        "prescriber": {
            "name": "Dana Whitfield, MD", "npi": "1730458822",
            "specialty": "Dermatology",
            "practice": "Lakeside Dermatology & Immunology",
            "phone": "(847) 555-0142", "fax": "(847) 555-0143",
            "tin": "36-4471902",
        },
        "policy": {"id": "AHP-SPX-118",
                   "title": "Interleukin-23 Inhibitors for Plaque Psoriasis",
                   "effective": "2026-01-01", "rev": "rev 2026-01"},
        "form": {"name": "Specialty Drug Prior Authorization Request",
                 "id": "AHP-PA-4412", "rev": "rev 2026-01",
                 "fields": 31, "completed": 31},
        "documents": [
            {"file": "enrollment.pdf", "label": "Prescriber Enrollment / Start Form",
             "cite": "Enrollment", "kind": "PDF"},
            {"file": "smn.pdf", "label": "Statement of Medical Necessity",
             "cite": "Medical Necessity", "kind": "PDF"},
            {"file": "chart_note.pdf", "label": "Dermatology Progress Note",
             "cite": "Chart Note", "kind": "PDF"},
            {"file": "lab_report.pdf", "label": "Laboratory & TB Screening Report",
             "cite": "Lab Report", "kind": "PDF"},
        ],
        "criteria": [
        ...
        "questions": [
            {"q": "What specialty drug is being requested?",
             ...
             "src": "Enrollment", "page": "p1", "conf": "high",
            ...
            {"q": "What is the primary diagnosis for the request?",
             ...
             "src": "Medical Necessity", "page": "p1", "conf": "high",
            ...
            {"q": "What is the documented disease severity?",
             "a": "BSA 18%, PASI 16.4",
             "src": "Chart Note", "page": "p1", "conf": "high",
            ...
            {"q": "Has tuberculosis screening been completed?",
             ...
             "src": "Lab Report", "page": "p1", "conf": "high",
        ...
        "packet": [
            {"label": "Enrollment: Prescriber Enrollment / Start Form", "criteria": "criteria 5",
             "why": "Documents the requested product, prescriber attestation, and patient consent."},
            {"label": "Medical Necessity: Statement of Medical Necessity", "criteria": "criteria 1, 3",
             "why": "Documents diagnosis, severity, and the conventional systemic therapy course."},
            {"label": "Chart Note: Dermatology Progress Note", "criteria": "criteria 1, 2",
             "why": "Documents body surface area, PASI, age, and response to prior therapy."},
            {"label": "Lab Report: Laboratory & TB Screening Report", "criteria": "criteria 4",
             "why": "Documents negative tuberculosis screening within twelve months."},
        ],
        "stages": [
            ["Document Intake & Extraction", "3.6 s", "1404 tok", "cache", "Velunexa 150 mg SC was requested"],
            ["Patient Context from CRM", "0 ms", "", "local", "10 FHIR resources from the CRM"],
            ["Policy Context from Policy PDF", "4.4 s", "1676 tok", "cache", "5 medical necessity criteria extracted"],
            ["PA Required?", "1.2 s", "1325 tok", "cache", "Prior authorization required"],
            ["Gather Required Documents", "2.8 s", "737 tok", "cache", "4 documents selected"],
            ["Complete Payer Questionnaire", "5.9 s", "3899 tok", "cache", "9 answered"],
            ["Complete Payer-Specific Form", "0 ms", "", "local", "31 form fields completed"],
            ["Prepare Submission Package", "1.9 s", "3589 tok", "cache", "All criteria met for Velunexa approval"],
        ],
        "submission": {
        ...
        "labs": [
            ["QuantiFERON-TB Gold Plus", "Negative", "Negative", "2026-07-18"],
            ["Hepatitis B surface antigen", "Non-reactive", "Non-reactive", "2026-07-18"],
            ["Hepatitis C antibody", "Non-reactive", "Non-reactive", "2026-07-18"],
            ["ALT", "26 U/L", "7 - 55 U/L", "2026-07-18"],
            ["AST", "23 U/L", "8 - 48 U/L", "2026-07-18"],
            ["Creatinine", "0.94 mg/dL", "0.74 - 1.35 mg/dL", "2026-07-18"],
            ["WBC", "6.8 K/uL", "4.5 - 11.0 K/uL", "2026-07-18"],
        ],
    },
    ...
    # ------------------------------------------------------------------ CASE 2
    {
        ...
        "flags": 0,
        "patient": {
            "name": "Priya Raman", "first": "Priya", "age": "41F",
            "dob": "1984-11-03", "sex": "Female", "pid": "PT-4471118",
            "phone": "(206) 555-0177",
            "address": "45 Fernwood Court, Bellevue, WA 98004",
        },
        "payer": {
            "name": "Cascadia Mutual", "short": "Cascadia",
            "plan": "Cascadia Mutual \u00b7 Cascadia Select HMO",
            "memberId": "CSM551903442", "group": "GRP-40188",
            "effective": "2026-01-01", "benefit": "Medical \u00b7 buy-and-bill",
        },
        "therapy": {
            "brand": "Ferexa", "generic": "ferric carbolate",
            "label": "Ferexa (ferric carbolate) 750 mg/15 mL",
            "cls": "Intravenous iron replacement",
            "strength": "750 mg/15 mL single-dose vial",
            "jcode": "J1439", "ndc": "58291-0750-02",
            "dose": "750 mg", "route": "Intravenous infusion",
            "frequency": "Two doses separated by at least 7 days",
            "quantity": "2 vials total", "daysSupply": "14",
            "siteOfCare": "In-network hospital-affiliated infusion suite",
            "duration": "Single course", "requestType": "Initial \u00b7 Standard",
            "startDate": "2026-09-02",
        },
        "dx": {"code": "D50.9", "text": "Iron deficiency anemia, unspecified",
               "full": "D50.9 \u00b7 Iron deficiency anemia, unspecified",
               "severity": "Hgb 9.1 g/dL \u00b7 ferritin 8 ng/mL"},
        "prescriber": {
            "name": "Sofia Marchetti, MD", "npi": "1487720933",
            "specialty": "Hematology",
            "practice": "Cascade Hematology Associates",
            "phone": "(206) 555-0119", "fax": "(206) 555-0120",
            "tin": "91-2233104",
        },
        "policy": {"id": "CSM-SPX-062",
                   "title": "Intravenous Iron Replacement Products",
                   "effective": "2026-01-01", "rev": "rev 2026-01"},
        "form": {"name": "Therapy Start Notification",
                 "id": "CSM-NOT-1180", "rev": "rev 2026-01",
                 "fields": 18, "completed": 18},
        "documents": [
            {"file": "enrollment.pdf", "label": "Prescriber Enrollment / Start Form",
             "cite": "Enrollment", "kind": "PDF"},
            {"file": "lab_report.pdf", "label": "Laboratory Report \u2014 CBC & Iron Studies",
             "cite": "Lab Report", "kind": "PDF"},
        ],
        "criteria": [
        ...
        "packet": [
            {"label": "Enrollment: Prescriber Enrollment / Start Form", "criteria": "criteria 1, 2",
             "why": "Documents the requested dose, the site of care, and prescriber attestation."},
            {"label": "Lab Report: Laboratory Report \u2014 CBC & Iron Studies", "criteria": "criteria 3",
             "why": "Documents the iron deficiency supporting the therapy start notification."},
        ],
        "stages": [
            ["Document Intake & Extraction", "2.1 s", "812 tok", "cache", "Ferexa 750 mg IV was requested"],
            ["Patient Context from CRM", "0 ms", "", "local", "8 FHIR resources from the CRM"],
            ["Policy Context from Policy PDF", "1.4 s", "1188 tok", "cache", "3 coverage rules extracted"],
            ["PA Required?", "1.1 s", "968 tok", "cache", "Prior authorization not required"],
            ["Gather Required Documents", "0.7 s", "402 tok", "cache", "2 documents selected"],
            ["Complete Payer Questionnaire", "", "", "skipped", "Not required under CSM-SPX-062"],
            ["Complete Payer-Specific Form", "", "", "skipped", "Not required under CSM-SPX-062"],
            ["Prepare Notification Package", "1.2 s", "1104 tok", "cache", "Therapy start notification ready"],
        ],
        "submission": {
        ...
        "labs": [
            ["Haemoglobin", "9.1 g/dL", "12.0 - 15.5 g/dL", "2026-08-19"],
            ["Haematocrit", "28.4 %", "34.9 - 44.5 %", "2026-08-19"],
            ["Mean corpuscular volume", "72 fL", "80 - 100 fL", "2026-08-19"],
            ["Ferritin", "8 ng/mL", "13 - 150 ng/mL", "2026-08-19"],
            ["Transferrin saturation", "9 %", "15 - 45 %", "2026-08-19"],
            ["Total iron binding capacity", "466 mcg/dL", "250 - 450 mcg/dL", "2026-08-19"],
            ["Serum iron", "31 mcg/dL", "50 - 170 mcg/dL", "2026-08-19"],
        ],
    },
    ...
    # ------------------------------------------------------------------ CASE 3
    {
        ...
        "flags": 1,
        "patient": {
            "name": "Daniel Okafor", "first": "Daniel", "age": "63M",
            "dob": "1962-04-27", "sex": "Male", "pid": "PT-4470885",
            "phone": "(614) 555-0163",
        ...
        "payer": {
            "name": "Anvara Health Plan", "short": "Anvara",
            "plan": "Anvara Health Plan \u00b7 Anvara Choice PPO",
            "memberId": "AVH884215090", "group": "GRP-77120",
            "effective": "2026-01-01", "benefit": "Medical \u00b7 specialty infusion",
        },
        "therapy": {
            "brand": "Zymvora", "generic": "alglucerase beta",
            "label": "Zymvora (alglucerase beta) 400 units",
            "cls": "Enzyme replacement therapy",
            "strength": "400 units per single-dose vial",
            "jcode": "J1786", "ndc": "58291-0400-04",
            "dose": "60 units/kg (5,100 units)", "route": "Intravenous infusion",
            "frequency": "Every 2 weeks",
            "quantity": "13 vials per fill", "daysSupply": "28",
            "siteOfCare": "Home infusion \u00b7 in-network provider",
            "duration": "12 months", "requestType": "Continuation \u00b7 Standard",
            "startDate": "2026-09-15",
        },
        "dx": {"code": "E75.22", "text": "Gaucher disease",
               "full": "E75.22 \u00b7 Gaucher disease, type 1",
               "severity": "On therapy 38 months \u00b7 stable"},
        "prescriber": {
            "name": "Nathan Cole, MD", "npi": "1902337415",
            "specialty": "Medical Genetics",
            "practice": "Riverbend Genetics & Metabolism",
            "phone": "(614) 555-0104", "fax": "(614) 555-0105",
            "tin": "31-5590417",
        },
        "policy": {"id": "AHP-SPX-204",
                   "title": "Enzyme Replacement Therapy for Gaucher Disease Type 1",
                   "effective": "2026-01-01", "rev": "rev 2026-01"},
        "form": {"name": "Specialty Drug Prior Authorization Request \u2014 Continuation",
                 "id": "AHP-PA-4418", "rev": "rev 2026-01",
                 "fields": 34, "completed": 33},
        "documents": [
            {"file": "enrollment.pdf", "label": "Prescriber Enrollment / Renewal Form",
             "cite": "Enrollment", "kind": "PDF"},
            {"file": "smn.pdf", "label": "Statement of Medical Necessity",
             "cite": "Medical Necessity", "kind": "PDF"},
            {"file": "chart_note.pdf", "label": "Metabolic Clinic Progress Note",
             "cite": "Chart Note", "kind": "PDF"},
            {"file": "lab_report.pdf", "label": "Laboratory Report \u2014 CBC & Biomarkers",
             "cite": "Lab Report", "kind": "PDF"},
        ],
        "criteria": [
        ...
        "packet": [
            {"label": "Enrollment: Prescriber Enrollment / Renewal Form", "criteria": "criteria 2, 5",
             "why": "Documents the continuation request, dose, and prescriber attestation."},
            {"label": "Medical Necessity: Statement of Medical Necessity", "criteria": "criteria 1",
             "why": "Documents the confirmed diagnosis and genetic testing result."},
            {"label": "Chart Note: Metabolic Clinic Progress Note", "criteria": "criteria 2",
             "why": "Documents duration of therapy and current clinical status."},
            {"label": "Lab Report: Laboratory Report \u2014 CBC & Biomarkers", "criteria": "criteria 3",
             "why": "Documents haematologic response within the six month window."},
            {"label": "Missing: Abdominal imaging within six months", "criteria": "criteria 4",
             "why": "Required to document organ volume response. Not present in the submitted packet.",
             "missing": True},
        ],
        "stages": [
            ["Document Intake & Extraction", "4.1 s", "1622 tok", "cache", "Zymvora 400 units IV was requested"],
            ["Patient Context from CRM", "0 ms", "", "local", "12 FHIR resources from the CRM"],
            ["Policy Context from Policy PDF", "4.8 s", "1904 tok", "cache", "5 medical necessity criteria extracted"],
            ["PA Required?", "1.3 s", "1341 tok", "cache", "Prior authorization required"],
            ["Gather Required Documents", "3.1 s", "846 tok", "cache", "4 of 5 required documents on file"],
            ["Complete Payer Questionnaire", "6.4 s", "4218 tok", "cache", "8 answered, 1 unanswered"],
            ["Complete Payer-Specific Form", "0 ms", "", "local", "33 of 34 form fields completed"],
            ["Prepare Submission Package", "2.2 s", "3744 tok", "cache", "1 criterion cannot be confirmed"],
        ],
        "submission": {
        ...
        "labs": [
            ["Haemoglobin", "13.4 g/dL", "13.5 - 17.5 g/dL", "2026-06-11"],
            ["Platelet count", "168 K/uL", "150 - 400 K/uL", "2026-06-11"],
            ["Chitotriosidase", "1,840 nmol/mL/h", "< 150 nmol/mL/h", "2026-06-11"],
            ["Glucosylsphingosine", "88 ng/mL", "< 15 ng/mL", "2026-06-11"],
            ["Ferritin", "312 ng/mL", "24 - 336 ng/mL", "2026-06-11"],
            ["ALT", "31 U/L", "7 - 55 U/L", "2026-06-11"],
            ["Angiotensin-converting enzyme", "62 U/L", "8 - 52 U/L", "2026-06-11"],
        ],
    },
    ...
    # ------------------------------------------------------------------ CASE 4
    {
        ...
        "flags": 2,
        "patient": {
            "name": "Alice Chen", "first": "Alice", "age": "37F",
            "dob": "1988-09-14", "sex": "Female", "pid": "PT-4471290",
            "phone": "(503) 555-0191",
            "address": "23 Cedar Hollow Way, Portland, OR 97209",
        },
        "payer": {
            "name": "Northgate Benefit Trust", "short": "Northgate",
            "plan": "Northgate Benefit Trust \u00b7 Northgate Open Access EPO",
            "memberId": "NGB771204831", "group": "GRP-63007",
            "effective": "2026-01-01", "benefit": "Pharmacy \u00b7 Specialty tier 4",
        },
        "therapy": {
            "brand": "Neuvexa", "generic": "obeltamab",
            ...
            "jcode": "J3031", "ndc": "58291-0140-01",
            "dose": "140 mg", "route": "Subcutaneous",
            "frequency": "Every 4 weeks",
            "quantity": "1 autoinjector per fill", "daysSupply": "28",
            "siteOfCare": "Self-administered \u00b7 specialty pharmacy",
            "duration": "12 months", "requestType": "Initial \u00b7 Standard",
            "startDate": "2026-09-10",
        },
        "dx": {"code": "G43.709", "text": "Chronic migraine without aura, intractable",
               "full": "G43.709 \u00b7 Chronic migraine without aura, intractable",
               "severity": "17 headache days per month"},
        "prescriber": {
            "name": "Elena Vasquez, MD", "npi": "1558904712",
            "specialty": "Neurology",
            "practice": "Harborview Neurology Group",
            "phone": "(503) 555-0136", "fax": "(503) 555-0137",
            "tin": "93-4418825",
        },
        "policy": {"id": "NGB-SPX-091",
                   "title": "CGRP Antagonists for Migraine Prophylaxis",
                   "effective": "2026-01-01", "rev": "rev 2026-01"},
        "form": {"name": "Specialty Drug Prior Authorization Request",
                 "id": "NGB-PA-3307", "rev": "rev 2026-01",
                 "fields": 27, "completed": 27},
        "documents": [
            {"file": "enrollment.pdf", "label": "Prescriber Enrollment / Start Form",
             "cite": "Enrollment", "kind": "PDF"},
            {"file": "chart_note.pdf", "label": "Neurology Progress Note",
             "cite": "Chart Note", "kind": "PDF"},
        ],
        "criteria": [
        ...
        "packet": [
            {"label": "Enrollment: Prescriber Enrollment / Start Form", "criteria": "criteria 4",
             "why": "Documents the requested product, prescriber specialty, and patient consent."},
            {"label": "Chart Note: Neurology Progress Note", "criteria": "criteria 1, 2",
             "why": "Documents headache frequency, age, and the single preventive agent trial."},
            {"label": "Missing: Second preventive agent trial of at least 8 weeks", "criteria": "criteria 3",
             "why": "Required to satisfy step therapy. Only topiramate, for five weeks, is documented.",
             "missing": True},
            {"label": "Missing: Step therapy exception documentation", "criteria": "criteria 3",
             "why": "Would reduce the requirement to one agent. No contraindication or adverse reaction is on file.",
             "missing": True},
        ],
        "stages": [
            ["Document Intake & Extraction", "2.4 s", "894 tok", "cache", "Neuvexa 140 mg SC was requested"],
            ["Patient Context from CRM", "0 ms", "", "local", "9 FHIR resources from the CRM"],
            ["Policy Context from Policy PDF", "4.1 s", "1588 tok", "cache", "5 medical necessity criteria extracted"],
            ["PA Required?", "1.2 s", "1276 tok", "cache", "Prior authorization required"],
            ["Gather Required Documents", "1.9 s", "612 tok", "cache", "2 of 3 required documents on file"],
            ["Complete Payer Questionnaire", "5.2 s", "3406 tok", "cache", "9 answered"],
            ["Complete Payer-Specific Form", "0 ms", "", "local", "27 form fields completed"],
            ["Prepare Submission Package", "2.0 s", "3288 tok", "cache", "Step therapy criteria not met"],
        ],
        "submission": {
        ...
        "labs": [
            ["Haemoglobin", "13.2 g/dL", "12.0 - 15.5 g/dL", "2026-08-04"],
            ["Platelet count", "264 K/uL", "150 - 400 K/uL", "2026-08-04"],
            ["Creatinine", "0.81 mg/dL", "0.59 - 1.04 mg/dL", "2026-08-04"],
            ["ALT", "19 U/L", "7 - 35 U/L", "2026-08-04"],
            ["Thyroid stimulating hormone", "2.1 mIU/L", "0.4 - 4.0 mIU/L", "2026-08-04"],
            ["Pregnancy test, serum", "Negative", "Negative", "2026-08-04"],
        ],
    },
]
